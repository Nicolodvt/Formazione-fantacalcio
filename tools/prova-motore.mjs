...
const sorgente = [
  ...
  pezzo('MOD_MIN_DIFENSORI', 'const'), pezzo('MOD_FASCE', 'const'), pezzo('MOD_INCERTEZZA', 'const'),
  pezzo('bonusModificatore'), pezzo('modificatoreAttesoCache', 'const'), pezzo('modificatoreAtteso'), pezzo('N_SIM', 'const'),
  pezzo('PESO_PRIOR_STAGIONE', 'const'),
  pezzo('DECADIMENTO_FORMA', 'const'), pezzo('pesoForma'), pezzo('mediaPesataForma'),
  pezzo('normalizzaSquadre'), pezzo('calcolaMvSquadre'), pezzo('misuraGruppo'), pezzo('giornateDelGruppo'),
